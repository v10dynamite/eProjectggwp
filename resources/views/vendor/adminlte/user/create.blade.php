        ...
        <div class="register-box">
            ...
            <div class="register-box-body">
                ...
                <form action="{{ url('user') }}" method="post">
                    ...
                    <div class="form-group has-feedback">
                        <select required class="form-control" name="gender" style="-webkit-appearance: none;-moz-appearance: none;appearance: none;color: gray;">
                    ...
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" placeholder="{{ trans('adminlte_lang::message.address') }}" name="address"/>
