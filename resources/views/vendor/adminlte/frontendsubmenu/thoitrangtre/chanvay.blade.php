...
{{ trans('adminlte_lang::message.thoitrangtre-chanvay') }}
@endsection



@section('thoitrangtre-chanvay')
			...
			<div class="row content">
				<div class="col-sm-3 sidenav">
					...
					<ul class="nav nav-pills nav-stacked">
						...
						<li class="active"><a href="{{ route('thoitrangtrechanvay') }}">CHÂN VÁY</a></li>
				...
				<div class="col-sm-9">
					<p>
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="{{ route('thoitrangtre') }}">THỜI TRANG TRẺ</a></li>
								<li class="breadcrumb-item active" aria-current="page">Chân váy</li>
							</ol>
						</nav> <hr>
