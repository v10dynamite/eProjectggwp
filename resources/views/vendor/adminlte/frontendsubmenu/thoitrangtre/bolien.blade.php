...
{{ trans('adminlte_lang::message.thoitrangtre-bolien') }}
@endsection



@section('thoitrangtre-bolien')
			...
			<div class="row content">
				<div class="col-sm-3 sidenav">
					...
					<ul class="nav nav-pills nav-stacked">
						...
						<li class="active"><a href="{{ route('thoitrangtrebolien') }}">BỘ LIỀN</a></li>
					</ul>
				</div>
					...
					<p>
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Bộ liền</li>
							</ol>
						</nav> <hr>
