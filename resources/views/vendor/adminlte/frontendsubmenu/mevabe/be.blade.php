...
{{ trans('adminlte_lang::message.mevabe-be') }}
@endsection
			...
			<div class="row content">
				<div class="col-sm-3 sidenav">
					...
					<ul class="nav nav-pills nav-stacked">
						...
						<li class="active"><a href="{{ route('mevabebe') }}">SẢN PHẨM BÉ</a></li>
					</ul>
				</div>
					...
					<p>
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Sản phẩm Bé</li>
							</ol>
						</nav> <hr>
